...
namespace ProyectoTransportesMana.Controllers
{
    public class EstudiantesController : Controller
    {
        ...
        public async Task<IActionResult> GestionEstudiantes()
        {
            ...
            var estResp = await client.GetAsync(api + "api/v1/estudiantes");
            ...
            var encResp = await client.GetAsync(api + "api/v1/encargados-legales");
            ...
            var instResp = await client.GetAsync(api + "api/v1/instituciones");
            ...
            var maesResp = await client.GetAsync(api + "api/v1/maestras");
